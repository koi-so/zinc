...
namespace zinc
{
	...
	template <typename T, typename A = sys_allocator<T>>
	class vector
	{
	public:
		// types:
		...
		vector(InputIt first, InputIt last, A &allocator);
		template <class InputIt>
	...
	template <typename T, typename A>
	vector<T, A>::vector(std::initializer_list<T> init)
			: vector(init, A()) {}
	...
	vector<T, A>::vector(vector<T, A> &&other)
			: m_allocator(other.m_allocator), m_capacity(other.m_capacity), m_size(other.m_size), m_arr(other.m_arr)
	{
		other.m_capacity = 0;
		other.m_size = 0;
		other.m_arr = nullptr;
	...
	template <typename T, typename A>
	auto vector<T, A>::assign(typename vector<T, A>::size_type count, const T &value) -> void
	{
		m_size = count;
		if (m_capacity < m_size)
		{
	...
	template <typename T, typename A>
	auto vector<T, A>::cbegin() const noexcept -> typename vector<T, A>::const_iterator
	{
		return m_arr;
	}
	...
	template <typename T, typename A>
	auto vector<T, A>::cend() const noexcept -> typename vector<T, A>::const_iterator
	{
		return m_arr + m_size;
	}

	template <typename T, typename A>
	auto vector<T, A>::rbegin() noexcept -> typename vector<T, A>::reverse_iterator
	{
		return reverse_iterator(m_arr + m_size);
	}

	template <typename T, typename A>
	auto vector<T, A>::crbegin() const noexcept -> typename vector<T, A>::const_reverse_iterator
	{
	...
	template <typename T, typename A>
	auto vector<T, A>::crend() const noexcept -> typename vector<T, A>::const_reverse_iterator
	{
		return const_reverse_iterator(m_arr);
	}

	template <typename T, typename A>
	inline void vector<T, A>::reallocate()
	{
	...
	template <typename T, typename A>
	auto vector<T, A>::max_size() const noexcept -> typename vector<T, A>::size_type
	{
		return std::numeric_limits<size_type>::max();
	}

	template <typename T, typename A>
	auto vector<T, A>::capacity() const noexcept -> typename vector<T, A>::size_type
	{
		return m_capacity;
	}
	...
	template <typename T, typename A>
	void vector<T, A>::resize(typename vector<T, A>::size_type size, const T &value)
	{
		if constexpr (std::is_trivial_v<T>)
		{
			if (size > m_size)
	...
	template <typename T, typename A>
	auto vector<T, A>::operator[](typename vector<T, A>::size_type index) -> typename vector<T, A>::reference
	{
		return m_arr[index];
	}

	template <typename T, typename A>
	auto vector<T, A>::operator[](typename vector<T, A>::size_type index) const -> typename vector<T, A>::const_reference
	{
		return m_arr[index];
	}

	template <typename T, typename A>
	auto vector<T, A>::at(typename vector<T, A>::size_type index) -> typename vector<T, A>::reference
	{
	...
	template <typename T, typename A>
	auto vector<T, A>::at(typename vector<T, A>::size_type index) const -> typename vector<T, A>::const_reference
	{
		ZINC_ASSERTF(index < m_size, "accessed position is out of range");
		return m_arr[index];
	}
	...
	template <typename T, typename A>
	auto vector<T, A>::data() const noexcept -> typename vector<T, A>::const_pointer
	{
		return m_arr;
	}
	...
	template <typename T, typename A>
	template <class... Args>
	auto vector<T, A>::emplace(typename vector<T, A>::const_iterator pos, Args &&...args) -> typename vector<T, A>::iterator
	{
	...
	template <typename T, typename A>
	auto vector<T, A>::insert(typename vector<T, A>::const_iterator pos, const T &value) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
		if (m_size == m_capacity)
		{
	...
	template <typename T, typename A>
	auto vector<T, A>::insert(typename vector<T, A>::const_iterator pos, T &&value) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
		if (m_size == m_capacity)
		{
	...
	template <typename T, typename A>
	auto vector<T, A>::insert(typename vector<T, A>::const_iterator pos, typename vector<T, A>::size_type count, const T &value) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
		if (!count)
			return iter;
	...
	template <typename T, typename A>
	template <class InputIt>
	auto vector<T, A>::insert(typename vector<T, A>::const_iterator pos, InputIt first, InputIt last) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
		size_type count = last - first;
		if (!count)
	...
	template <typename T, typename A>
	auto vector<T, A>::insert(typename vector<T, A>::const_iterator pos, std::initializer_list<T> ilist) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
	...
	template <typename T, typename A>
	auto vector<T, A>::erase(typename vector<T, A>::const_iterator pos) -> typename vector<T, A>::iterator
	{
		iterator iter = &m_arr[pos - m_arr];
		if constexpr (!std::is_trivial_v<T>)
			(*iter).~T();
	...
	template <typename T, typename A>
	auto vector<T, A>::erase(typename vector<T, A>::const_iterator first, typename vector<T, A>::const_iterator last) -> typename vector<T, A>::iterator
	{
